...
#define ENUM_ITEM(_NAME, _DESCRIPTION)                    \
    case EnumType::_NAME:                                 \
        return MakeJSONValue(TSTRING(#_NAME), allocator); \
        break;

#define ENUM_END()                                             \
    default:                                                   \
        return MakeJSONValue(TSTRING("<Unknown>"), allocator); \
        break;                                                 \
        }                                                      \
        }
...
rapidjson::Value MakeJSONValue(const lucid::UUID& value, rapidjson::Document::AllocatorType& allocator)
{
    rapidjson::Value ret;
    ret.SetString(&value.str()[0], allocator);
    return ret;
}

rapidjson::Value MakeJSONValue(const lucid::scene::EStaticMeshType& value, rapidjson::Document::AllocatorType& allocator)
{
    rapidjson::Value ret;
    ret.SetInt(static_cast<uint8_t>(value));
    return ret;
...
rapidjson::Value MakeJSONValue(const lucid::scene::ELightUnit& value, rapidjson::Document::AllocatorType& allocator)
{
    rapidjson::Value ret;
    ret.SetInt(static_cast<uint8_t>(value));
    return ret;
...
rapidjson::Value MakeJSONValue(const lucid::scene::ELightSourceType& value, rapidjson::Document::AllocatorType& allocator)
{
    rapidjson::Value ret;
    ret.SetInt(static_cast<uint8_t>(value));
    return ret;
