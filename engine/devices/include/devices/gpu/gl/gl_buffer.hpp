...
namespace lucid::gpu
{
    class CGLBuffer : public CGPUBuffer
    {
      public:
        ...
        virtual void* MemoryMap(const EBufferMapPolicy& InAccessPolicy, const u32& InSize = 0, const u32& InOffset = 0) override;
        virtual void  MemoryUnmap() override;

        virtual void CopyDataTo(CGPUBuffer* OtherBuffer, const u32& InSize = 0, const u32& InReadOffset = 0, const u32& InWriteOffset = 0) override;
