...
STRUCT_BEGIN(lucid, FSkyboxDescription, "")
    ...
    STRUCT_FIELD(UUID, BaseActorResourceId, sole::INVALID_UUID, "Id of the base actor resource that this actor is an instance of")	
    STRUCT_FIELD(InstancedVariable<UUID>, RightFaceTexture, lucid::InstancedVariable<lucid::UUID>{}, "")	
    STRUCT_FIELD(InstancedVariable<UUID>, LeftFaceTexture, lucid::InstancedVariable<lucid::UUID>{}, "")	
    STRUCT_FIELD(InstancedVariable<UUID>, TopFaceTexture, lucid::InstancedVariable<lucid::UUID>{}, "")	
    STRUCT_FIELD(InstancedVariable<UUID>, BottomFaceTexture, lucid::InstancedVariable<lucid::UUID>{}, "")	
    STRUCT_FIELD(InstancedVariable<UUID>, FrontFaceTexture, lucid::InstancedVariable<lucid::UUID>{}, "")	
    STRUCT_FIELD(InstancedVariable<UUID>, BackFaceTexture, lucid::InstancedVariable<lucid::UUID>{}, "")	
STRUCT_END()
